...
export declare function parseOpcContentTypesXml(xml: string): OpcContentTypes;
...
export declare function readZipPackage(data: Uint8Array): { entries: ZipEntry[]; diagnostics: unknown[] };
